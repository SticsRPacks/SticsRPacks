...
It can be accessed just by clicking [here](https://mybinder.org/v2/git/https%3A%2F%2Fforge.inrae.fr%2Fstics-formation%2Fsticsrpacks-binder.git/v0.11.1?urlpath=rstudio), thanks to [@eric.casellas](https://forge.inrae.fr/eric.casellas).

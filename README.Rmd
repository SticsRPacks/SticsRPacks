...
The first time it is started, the tutorial takes a few minutes to initialize in order to download all the materials and run the solutions. For subsequent runs, the tutorial will thus start almost immediately from the second run.
...
It can be accessed just by clicking [here](https://mybinder.org/v2/git/https%3A%2F%2Fforge.inrae.fr%2Fstics-formation%2Fsticsrpacks-binder.git/v0.11.0?urlpath=rstudio), thanks to [@eric.casellas](https://forge.inrae.fr/eric.casellas).

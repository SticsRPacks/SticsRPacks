...
It can be accessed just by clicking [here](https://mybinder.org/v2/git/https%3A%2F%2Fforge.inraefr%2Fstics-formation%2Fsticsrpacks-binder.git/v0.9.0?urlpath=rstudio), thanks to [@eric.casellas](https://forge.inrae.fr/eric.casellas).

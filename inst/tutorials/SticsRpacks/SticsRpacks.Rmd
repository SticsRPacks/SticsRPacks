...
sim <- get_sim(workspace = workspace_xml, usm_name = usms)
```
...
```{r prepare-wrapper, echo=TRUE, message=TRUE}
...
```{r prepare-param-estim, echo=FALSE}
wrapper_options = stics_wrapper_options(javastics_path = javastics, data_dir = workspace_xml, parallel = TRUE)
...
```{r prepare-param-estim-out, echo=FALSE}

...
if (!local_javastics) {
  ...
  #}
  # javastics_dir <- list.files(work_dir, 
  #                             recursive = FALSE,
  #                             full.names = FALSE,
  #                             pattern = "^JavaSTICS")
  
  #javastics_path <- file.path(work_dir, javastics_dir)
  
  
  workspace_path <- file.path(javastics_path, "example", fsep = "/")
  
  #stop("debug", javastics_path, workspace_path)
...
# according to the used version in JavaStics
if (linux) {
  java <- check_java_version(java_target)
  # java <- "java"
...
# Copying workspace_PW1 files of the package to a new directory, 
# and fixing the new workspace_PW1 path
# tmp_workspace_PW1 <- file.path(tmp_dir, basename(workspace_PW1))
# if (!dir.exists(tmp_workspace_PW1)) {
#   dir.create(tmp_workspace_PW1)
# }
# 
# R.utils::copyDirectory(
#   from = file.path(system.file(package = "SticsRPacks"), workspace_PW1),
#   to = tmp_workspace_PW1, 
#   recursive = TRUE
# )
# 
# workspace_PW1 <- tmp_workspace_PW1

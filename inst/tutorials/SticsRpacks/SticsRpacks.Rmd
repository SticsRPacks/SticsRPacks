...
Let's see how the first session would look like in R using SticsRpacks.
...
But don't worry if you don't understand anything, you'll learn everything you need to know in this tutorial. We just want you to see that you can make a parameter optimisation under 30 lines of code, including the plots of the improvement of the resulting simulated variable of interest against observations. And the good news is when you understand these lines of code, you'll be able to do almost anything with the packages, because it doesn't get any longer or more complex than this.  

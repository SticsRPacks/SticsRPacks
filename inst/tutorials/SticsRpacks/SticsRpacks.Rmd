...
if (!local_javastics) {
  ...
  download_url <- "https://w3.avignon.inrae.fr/forge/attachments/download/3706/JavaSTICS-latest.zip"
  ...
  if (stics_version_num < get_version_num(9)) {
    stop(
      "The JavaSTICS distribution ",
      basename(javastics_path),
      "is too old and not supported in this tutorial"
    )
  } else if (stics_version_num < get_version_num(10)) {
    workspace_PW1 <- "tutorials/SticsRpacks/PW1_V9.2"
    java_target <- "8"
  } else if (stics_version_num < get_version_num(10.1)) {
    workspace_PW1 <- "tutorials/SticsRpacks/PW1_V10"
    java_target <- "11"
  } else if (stics_version_num < get_version_num(11)) {
    workspace_PW1 <- "tutorials/SticsRpacks/PW1_V10"
    java_target <- "17"
  } else if (stics_version_num < get_version_num(12)) {
    workspace_PW1 <- "tutorials/SticsRpacks/PW1_V11"
    java_target <- "17"
  } else {
    stop(

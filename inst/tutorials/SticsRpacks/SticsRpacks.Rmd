...
if(SticsRFiles:::get_version_num(stics_version) < 10) { 
  ...
  if (linux) {
    if(java == "")
      stop("The default system java virtual machine\n",system("java -version 2>&1", intern = TRUE)[1], 
      "\nis not correct for running JavaStics\n", 
      "A java 11 path is needed to be specified in a .Renviron file, in a JAVA variable.\n",
      "for example:\n",

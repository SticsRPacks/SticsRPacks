...
> Getting simulations outputs of USMs from the workspace directory used in the previous exercise for running the model
...
Par défaut, dans la colonne Plant l'identifiant de la plante est stocké (plant_1, plant_2).
Si le chemin du fichier usms.xml est fourni, la colonne Plant contiendra le nom du fichier plante.
</div>
...
* Try to get observations for specific variables and combination with USMs 

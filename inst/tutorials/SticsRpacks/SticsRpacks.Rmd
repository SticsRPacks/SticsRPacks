...
Names of STICS variables can be retrieved using the `get_var_info` function from partial name or keywords.

**Function** `get_var_info` from the [SticsRFiles package](https://sticsrpacks.github.io/SticsRFiles/index.html)
...
```{r stics_wrapper1-setup, echo=FALSE}
...
```{r stics_wrapper1, exercise=TRUE}

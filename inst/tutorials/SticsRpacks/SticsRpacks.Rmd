...
if(SticsRFiles:::get_version_num(stics_version) < 10) { 
  ...
  javastics_dir <- "JavaSTICS-1.5.0-STICS-10.0.0"
  workspace_path <- "JavaSTICS-1.5.0-STICS-10.0.0/example"
  # to remove when the V10.0.0 will be out
  user_passwd <- SticsRPacks:::get_forge_userpass("internal")
  download_url <- "https://w3.avignon.inra.fr/forge/attachments/download/2932/"

...
```{r estim_param3, exercise=TRUE, exercise.setup = "prepare-wrapper-plot"}
# Insert your R code here!
```
...
> Use `plot()` to make a dynamic plot of the simulations along with the observations (`obs_filt`).

```{r estim_param4, exercise=TRUE, exercise.setup = "prepare-wrapper-plot"}
# Insert your R code here!
```
...
#SOLUTION:
plot(sim = sim_optim, obs = obs_filt)
```

We can also make a scatter plot instead.

> Make the same plot but as a scatter plot instead of a dynamic plot

```{r estim_param5, exercise=TRUE, exercise.setup = "prepare-wrapper-plot"}
# Insert your R code here!
```
...
#SOLUTION:
plot(sim = sim_optim, obs = obs_filt, type = "scatter")
```

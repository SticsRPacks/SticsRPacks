...
stics_version_num <- SticsRFiles:::get_version_num(stics_version)
...
if (!local_javastics) {
  ...
  # the 3 Stics versions taken into account in the tuto data
...
if (linux) {
  ...
  if (java_version < java_target)
    stop("The default system java virtual machine is ",
         system(paste(java, "-version 2>&1"),
                intern = TRUE)[1],
         "\nA java ", as.character(java_target), " version installation is needed for running JavaSTICS, \n",

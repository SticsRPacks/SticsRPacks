...
### Get information from Stics XML files
...
# Get the values of clay content after decarbonation (argi) for all soils defined in the JavaStics distribution Example directory
```
...
get_param_xml(file.path(workspace,"sols.xml"), c("norg"))
```

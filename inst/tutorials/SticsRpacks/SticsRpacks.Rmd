...
**SAMUEL: Ajouter un exercice pour filtrer les USMS ???** 
...
question("How are organized the results for the different intercrops",
  ...
  answer("You're not lucky ... it is the other proposition!"),
  incorrect = "...",
  random_answer_order = TRUE,
  allow_retry = TRUE)
```
...
sim <- get_sim(workspace = workspace_xml, usm_name="intercrop_pea_barley",
               ...
               usms_filename=file.path(workspace_xml,"usms.xml"))
print(sim)
# The names of the Plants are now given in the Plant column instead of Plant_1 and Plant_2 ...
```


**SAMUEL: La SOLUTION PRECEDENTE SEMBLE NE PAS FONCTIONNER: A VOIR**

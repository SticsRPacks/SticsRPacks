...
SticsRPacks is a set of packages for managing the STICS crop model from R. 
...
* the Reference tab at the top of the packages websites home pages, that list and quickly describe all the exported functions of the packages, and give a link to their detailed documentation,
...
But don't worry if you don't understand anything, you'll learn everything you need to know in this tutorial. We just want you to see that you can make a parameter optimisation under 30 lines of code, including the plots with observations. And the good news is when you understand these lines of code, you'll be able to do almost anything with the packages, because it doesn't get any longer or more complex than this.  
...
#,
# usms_list = c("banana","Turmeric", "wheat", "maize"))
```
